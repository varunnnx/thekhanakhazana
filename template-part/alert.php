...
<?php
    if(isset($_GET['result'])){
		...
		}if($_GET['result'] == 'wrong-captcha'){
			echo '<span class="hide-alert danger">Captcha Entered Wrong&nbsp;&nbsp;<i class="fa-solid fa-circle-exclamation"></i></span>';
		}if($_GET['result'] == 'wrong-otp'){
			echo '<span class="hide-alert danger">Wrong OTP&nbsp;&nbsp;<i class="fa-solid fa-circle-exclamation"></i></span>';
		}if($_GET['result'] == 'pass-dont-match'){
			echo '<span class="hide-alert danger">Both Password not Same&nbsp;&nbsp;<i class="fa-solid fa-circle-exclamation"></i></span>';
		}
	}
?>
</div>